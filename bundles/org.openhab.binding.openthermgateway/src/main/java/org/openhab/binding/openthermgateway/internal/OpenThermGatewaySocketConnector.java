...
public class OpenThermGatewaySocketConnector implements OpenThermGatewayConnector {
    ...
    public void run() {
        ...
        scheduler.submit(() -> callback.connecting());
        ...
        try (Socket socket = new Socket()) {
            ...
            scheduler.submit(() -> callback.connected());
            ...
            scheduler.submit(() -> callback.disconnected());
        }
    }
    ...
    /**
     * public method could be called from either OH main thread or this thread so it is synchronized
     */
    @Override
    ...
    private void handleMessage(String message) {
        ...
        if (msg.getMessageType() == MessageType.READACK || msg.getMessageType() == MessageType.WRITEDATA
            ...
            scheduler.submit(() -> callback.receiveMessage(msg));
        }
    }
}
